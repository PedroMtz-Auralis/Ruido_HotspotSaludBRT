...
map.getView().fit([-11865144.552200, 3702276.151204, -11833649.593948, 3734754.321141], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Hotspot Ruido Centros de Salud Vs Vialidad Primaria</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (746 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'El presente trabajo se inscribe en esta línea de investigación y propone un modelo de<br />análisis multicriterio espacial orientado a la identificación de zonas críticas de exposición<br />acústica en un corredor BRT de la ciudad de Ciudad Juárez, México. El modelo integra<br />indicadores acústicos temporales derivados de aforos vehiculares continuos, índices<br />psicoacústicos proxy construidos en entorno SIG y un esquema de priorización basado en<br />el Proceso Analítico Jerárquico (AHP). A diferencia de aproximaciones centradas<br />exclusivamente en la severidad sonora, el enfoque adoptado distingue entre distintas<br />lógicas de evaluación —planeación urbana y salud/ruido— permitiendo explorar<br />coincidencias, tensiones y zonas de consenso o disenso territorial. ';
            }
